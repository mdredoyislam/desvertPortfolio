...
Redux::setSection( $opt_name,
	array(
		...
		'fields' => array(
			array(
				'id'       => 'footer-about-start',
				'type'     => 'section',
				'indent' => true,
				'title'    => esc_html__( 'Footer About Options', 'desvert' ),
				'desc'     => esc_html__( 'Footer About Options','desvert' ),
			),
			array(
				'id'       => 'footer-about-title',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer About Title', 'desvert' ),
				'desc'     => esc_html__( 'Footer About Title Here','desvert' ),
			),
			array(
				'id'       => 'footer-about-sub-title',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer About Sub Title', 'desvert' ),
				'desc'     => esc_html__( 'Footer About Sib Title Here','desvert' ),
			),
			array(
				'id'       => 'footer-about-text',
				'type'     => 'textarea',
				'title'    => esc_html__( 'Footer About Info', 'desvert' ),
				'desc'     => esc_html__( 'Footer About Info Here','desvert' ),
			),
			array(
				'id'       => 'footer-about-btn-text',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer About Button Text', 'desvert' ),
				'desc'     => esc_html__( 'Footer About Button Text Here','desvert' ),
				'default'   => esc_html__( 'know More','desvert' ),
			),
			array(
				'id'       => 'footer-about-btn-url',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer About Button Url', 'desvert' ),
				'desc'     => esc_html__( 'Footer About Button Url Here','desvert' ),
				'default'   => esc_html__( '#','desvert' ),
			),
			array(
				'id'       => 'footer-about-end',
				'type'     => 'section',
			...
			array(
				'id'       => 'footer-wrapper-start',
				'type'     => 'section',
				'indent' => true,
				'title'    => esc_html__( 'Footer Wrapper Options', 'desvert' ),
				'desc'     => esc_html__( 'Footer Wrapper Options','desvert' ),
			),
			array(
				'id'       => 'footer-wrapper-title',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer Wrapper Title', 'desvert' ),
				'desc'     => esc_html__( 'Footer Wrapper Title Here','desvert' ),
			),
			array(
				'id'       => 'footer-wrapper-end',
				'type'     => 'section',
				'indent' => false,
			),
			array(
				'id'       => 'footer-whatsapp-start',
				'type'     => 'section',
				'indent' => true,
				'title'    => esc_html__( 'Footer WhatsApp Options', 'desvert' ),
				'desc'     => esc_html__( 'Footer WhatsApp Options','desvert' ),
			),
			array(
				'id'       => 'footer-whatsapp-title',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer WhataApp Title', 'desvert' ),
				'desc'     => esc_html__( 'Footer WhataApp Title Here','desvert' ),
			),
			array(
				'id'       => 'footer-whatsapp-number',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer WhataApp Number', 'desvert' ),
				'desc'     => esc_html__( 'Footer WhataApp Number Here','desvert' ),
				'default'   => esc_html__( '+880 123 456 7890','desvert' ),
			),
			array(
				'id'       => 'footer-whatsapp-icon-img',
				'type'     => 'media',
				'title'    => esc_html__( 'Footer WhataApp icon', 'desvert' ),
				'desc'     => esc_html__( 'Footer WhataApp Icon Here','desvert' ),
			),
			array(
				'id'       => 'footer-whatsapp-end',
				'type'     => 'section',
				'indent' => false,
			),
			array(
				'id'       => 'footer-email-start',
				'type'     => 'section',
				'indent' => true,
				'title'    => esc_html__( 'Footer Email Options', 'desvert' ),
				'desc'     => esc_html__( 'Footer Email Options','desvert' ),
			),
			array(
				'id'       => 'footer-email-title',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer Email Title', 'desvert' ),
				'desc'     => esc_html__( 'Footer Email Title Here','desvert' ),
			),
			array(
				'id'       => 'footer-email',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer Email ID', 'desvert' ),
				'desc'     => esc_html__( 'Footer Email ID Here','desvert' ),
				'default'   => esc_html__( 'domainname@gmail.com','desvert' ),
			),
			array(
				'id'       => 'footer-email-icon-img',
				'type'     => 'media',
				'title'    => esc_html__( 'Footer Email icon', 'desvert' ),
				'desc'     => esc_html__( 'Footer Email Icon Here','desvert' ),
			),
			array(
				'id'       => 'footer-email-end',
				'type'     => 'section',
			...
			array(
				'id'       => 'footer-contact-start',
				'type'     => 'section',
				'indent' => true,
				'title'    => esc_html__( 'Footer Contact Options', 'desvert' ),
				'desc'     => esc_html__( 'Footer Contact Options','desvert' ),
			),
			array(
				'id'       => 'footer-contact-title',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer Contact Title', 'desvert' ),
				'desc'     => esc_html__( 'Footer Contact Title Here','desvert' ),
			),
			array(
				'id'       => 'footer-contact-address',
				'type'     => 'textarea',
				'title'    => esc_html__( 'Footer Contact Address', 'desvert' ),
				'desc'     => esc_html__( 'Footer Contact Address Here','desvert' ),
				'default'   => esc_html__( 'Company Address Here','desvert' ),
			),
			array(
				'id'       => 'footer-email-end',
				'type'     => 'section',
